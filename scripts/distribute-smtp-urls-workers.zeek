...
#redef Cluster::manager2worker_events += /SMTPurl::m_w_smtpurls_add|SMTPurl::m_w_add_url_to_bloom/;
#redef Cluster::worker2manager_events += /SMTPurl::w_m_smtpurls_new|SMTPurl::w_m_url_click|SMTPurl::w_m_url_click_in_bloom/;
#@endif
